// from http://webdesign.torn.be/tutorials/javascript/prototype/auto-expand-contract-textarea/#demo
...
﻿document.observe("dom:loaded", function() {
	...
	function autoExpandContract(el) {
		...
		// I (ST) added the next line to resolve issue with resizing font - tested only in FF 3
		dummy.style.lineHeight = getStyleFromCSS(el, 'line-height')+'px';
		...
		// hide the created div away - originaly just moved of screen below, but I (ST) hid it properly above
